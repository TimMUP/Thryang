...
$(document).ready(function () {
    ...
    const introButton = document.getElementById('select-introduction').getBoundingClientRect();
    var introTopPos = $('#block-introduction').offset().top - convertRemToPixels(1)
    const experButton = document.getElementById('select-projects').getBoundingClientRect();
    var experTopPos = $('#block-projects').offset().top - convertRemToPixels(1)
    const projsButton = document.getElementById('select-manuscripts').getBoundingClientRect();
    var projsTopPos = $('#block-manuscripts').offset().top - convertRemToPixels(1)
    const skillButton = document.getElementById('select-blogs').getBoundingClientRect();
    var skillTopPos = $('#block-blogs').offset().top - convertRemToPixels(1)
    ...
    $('#select-introduction').click(function () { aniPointer(1, true) });
    $('#select-projects').click(function () { aniPointer(2, true) });
    $('#select-manuscripts').click(function () { aniPointer(3, true) });
    $('#select-blogs').click(function () { aniPointer(4, true) });
